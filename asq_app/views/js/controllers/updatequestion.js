...
app.controller('updateQuestionCtrl', function ($q, $scope, $rootScope, $http, $location) {
    ...
    $scope.questionCategory = $scope.addQueCat;
    $scope.questionContent = $scope.addCont;
    $scope.questionChoices = $scope.addCho;
    $scope.correctChoice = $scope.addCorCh;
    ...
    $scope.updateQuestion = function () {
        ...
        var postData = {
            ...
            choices: JSON.parse(formatChoice), //$scope.choice.split("\n"),
            correctChoice: $scope.correctChoice
        };
